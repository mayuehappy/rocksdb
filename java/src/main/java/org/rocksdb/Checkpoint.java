...
public class Checkpoint extends RocksObject {
  ...
  public ExportImportFilesMetaData exportColumnFamily(final ColumnFamilyHandle columnFamilyHandle, final String exportPath)
    throws RocksDBException {
  ...
  private native ExportImportFilesMetaData exportColumnFamily(long handle, long columnFamilyHandle, String exportPath)
      throws RocksDBException;
}
