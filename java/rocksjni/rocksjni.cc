 ...
 * Signature: (J[BIJJI[[B[I[[[B[[I[[Ljava/lang/String;[[Ljava/lang/String;[[J[[J[[J[[[B[[[B[[J[[Z[[J[[J)J
 */
jlong Java_org_rocksdb_RocksDB_createColumnFamilyWithImport(
  JNIEnv* env, jobject, jlong jdb_handle, jbyteArray jcf_name, jint jcf_name_len, jlong j_cf_options, jlong j_cf_import_options,
   jint metadata_num, jobjectArray j_db_comparator, jintArray j_level_meta_size, jobjectArray j_cf_names, jobjectArray j_levels, jobjectArray j_file_names, jobjectArray j_paths, jobjectArray j_sizes, jobjectArray j_smallest_seq, jobjectArray j_largest_seq, jobjectArray j_smallest_keys, jobjectArray j_largest_keys, jobjectArray j_num_read_sample, jobjectArray j_being_compacted, jobjectArray j_num_entries, jobjectArray j_num_deletions) {
  ...
  auto* cf_import_options = reinterpret_cast<ROCKSDB_NAMESPACE::ImportColumnFamilyOptions*>(
      j_cf_import_options);

  std::vector<const ExportImportFilesMetaData*> metadatas;

  ExportImportFilesMetaData metadata;

  ROCKSDB_NAMESPACE::ColumnFamilyHandle* cf_handle;
  ROCKSDB_NAMESPACE::Status s =
      db->CreateColumnFamilyWithImport(*cf_options, cf_name, *cf_import_options, metadatas, &cf_handle);
  if (!s.ok()) {
    // error occurred
    ROCKSDB_NAMESPACE::RocksDBExceptionJni::ThrowNew(env, s);
    return 0;
