 ...
 */
jobject Java_org_rocksdb_Checkpoint_exportColumnFamily(JNIEnv* env, jobject /*jobj*/,
                                                  jlong jcheckpoint_handle,
                                                  jlong jcolumn_family_handle,
                                                  jstring jexport_path) {
  ...
  ROCKSDB_NAMESPACE::ExportImportFilesMetaData* metadata;

  ROCKSDB_NAMESPACE::Status s = checkpoint->ExportColumnFamily(column_family_handle, export_path, &metadata);
  ...
  if (metadata != nullptr) {
    jexport_import_files_meta_data = ROCKSDB_NAMESPACE::ExportImportFilesMetaDataJni::fromCppExportImportFilesMetaData(env, metadata);
  }
